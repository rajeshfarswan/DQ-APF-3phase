/* harmonic oscilator to generate sine and cosine references*/

;void return and void argument
;access and modify these integer variables qSin, qCos in main
;int OSC_F (50 HZ value in Q15) is the input to harmonic oscillator -0.999<=OSC_F<=+0.999
